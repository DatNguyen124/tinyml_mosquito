...
const char* ei_classifier_inferencing_categories[] = { "aegypti", "albopictus", "noise", "other" };
...
const ei_impulse_t impulse_583374_0 = {
    .project_id = 583374,
    .project_owner = "Thái Duy Đinh",
    .project_name = "mos",
    .impulse_id = 1,
    .impulse_name = "Time series data, Spectrogram, Classification (Keras)",
    .deploy_version = 9,

    .nn_input_frame_size = 5135,
...
ei_impulse_handle_t impulse_handle_583374_0 = ei_impulse_handle_t( &impulse_583374_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_583374_0;
